...
public class Sword : Weapon
{
    public override void Attack(PlayerController controller)
    {
        ...
        var touched = Physics2D.OverlapBoxAll(controller.transform.position+new Vector3(controller.dir.x,controller.dir.y,0)*16,new Vector2(16*(1+(2*Mathf.Abs(controller.dir.y))),16*(1+(2*Mathf.Abs(controller.dir.x)))),0);
